  ...
  return (
    <Container>
      ...
      <Incoming>
        ...
        <SeparatorBox>
          <GamesInfo
            gameSlug="senuas-saga-hellblade-II"
          ...
          />
          <GamesInfo
            gameSlug="STALKER-2-heart-of-chornobyl"
